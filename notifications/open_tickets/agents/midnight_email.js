...
const midnight_email = (past_array, agent, cc)=>{
  
        let to = agent.email;
    
        let subject = past_array.length+ ' OPEN TICKETS REMINDER'
        let header1 = past_array.length+ ' OPEN TICKETS '
        let header2 = 'REMINDER'
       
        
     
       
      
        let message = `<p>Please login to precision desk to solve the following tickets. More than 2hrs have passed.</p>
        <br/>
