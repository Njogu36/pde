...
const send_email = (past_array, agents, administrators)=>{
    if(agents !== undefined && administrators !== undefined)
    {
        let to = [];
        let cc = []
        let subject = past_array.length+ ' NEW TICKETS REMINDERS'
        let header1 = past_array.length+ ' NEW TICKETS '
        let header2 = 'REMINDERS'
        ...
        let message = `<p>Please login to precision desk to view the following tickets. More than 2hrs have passed.</p>
        <br/>
