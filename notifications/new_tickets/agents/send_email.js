...
const send_email = (user,ticket,time,agents,type)=>{
    console.log(6)
        let to = [];
        let subject = 'NEW TICKET REMINDER - T-ID: '+ticket.id
        let header1 = 'NEW TICKET REMINDER - T-ID: '
        let header2 = ticket.id
       
        const link = 'https://test.precision.ke/admin/dashboard/my-assigned-tickets/details/'+ticket.id
     
        if(!Array.isArray(agents))
        {
             to.push(agents.email)  
        }
        else
        {
            agents.map((item)=>{
        ...
        let message = `<p>Dear administrator, please login to precision desk to view the following ticket. ${type === 'hrs' ? time+` hrs`: time+ ` minutes`} have passed.</p>
    
        <br/>
        <h4>T-ID: ${ticket.id}</h4>
        <br/>
        <h6>Subject: ${ticket.subject}</h6>
        <p>Description: ${ticket.description}</p>
        <p>Requester: ${user.name}</p>
        <p>
        <a href=${link} style='background-color:#3e3574;padding:10px;color:white;margin-top:10px;text-decoration:none;margin-top:20px'>Click Here</a></p>`
                ...
                <tr>
                    <td>
                        <div style="overflow:hidden;display:none;font-size:1px;color:#ffffff;line-height:1px;font-family:Arial;maxheight:0px;max-width:0px;opacity:0;">
                          PrecisionDesk Email Notification
                        </div>
                    </td>
                </tr>
            </table>
                            ...
                            <tr>
                                <td align="center" style="color: #343434; font-size: 24px; font-family: Quicksand, Calibri, sans-serif; font-weight:700;letter-spacing: 3px; line-height: 35px;" class="main-header">
                                    ...
                                    <div style="line-height: 35px">
                                        ...
                                        ${header1} <span style="color: #3e3574">${header2}</span>
                                        ...
                                        <tr>
                                            <td align="left" style="color: #aaaaaa; font-size: 14px; font-family: 'Work Sans', Calibri, sans-serif; line-height: 24px;">
                                                <div style="line-height: 24px;">
                                                    ...
                                                    <span style="color: #333333;">Revenue Stadia</span>
